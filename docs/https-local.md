...
UFW permite HTTPS 443 solo desde la subred local. Los puertos 3000, 3001, 8080 y 20211 no tienen reglas de entrada. Una regla adicional y limitada permite que la red Docker de Uptime Kuma consulte Caddy en 443.
...
sudo ss -ltnp | grep -E ':443|:3000|:3001|:8080|:20211'
